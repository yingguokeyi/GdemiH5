...
var myProx = localStorage.getItem('myProx');
var myCityx = localStorage.getItem('myCityx');
var myAreax = localStorage.getItem('myAreax');
var opt0 = [myProx,myCityx,myAreax];//初始值
